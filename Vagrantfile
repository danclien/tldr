...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider "lxc" do |lxc, override|
    override.vm.box = "danclien/xenial64-lxc"
    override.vm.box_url = "https://storage.googleapis.com/static.danclien.com/vagrant/vagrant-lxc-xenial-amd64.box"

    # Uncomment to allow Docker to run inside the container
